  ...
  public void write(Iterator<Product2<K, V>> records) throws IOException {
    ...
    try {
      ...
      for (int i = 0; i < numPartitions; i++) {
        /**
         * var blockId = new TempShuffleBlockId(UUID.randomUUID()) 【name: String = "temp_shuffle_" + id】
         * 如果根据 该 blockId 创建的临时文件已经存在则刷新 blockId
         */
        final Tuple2<TempShuffleBlockId, File> tempShuffleBlockIdPlusFile =
            blockManager.diskBlockManager().createTempShuffleBlock();
        /**
         * 根据 BlockId.name 创建 File
         */
        final File file = tempShuffleBlockIdPlusFile._2();
        final BlockId blockId = tempShuffleBlockIdPlusFile._1();
        /**
         * 初始化 DiskBlockObjectWriter(继承于OutputStream)
         * file(目标文件)
         * fileBufferSize(文件大小)
         *
         */
      ...
      /**
       * partitionWriters  -》 [ blockId、File、getPartition(key) ]
       *
       *
       *
       *
      ...
      while (records.hasNext()) {
        ...
        /**
         * 写入记录到文件[根据key找到其所属的partition] -》 获取到对应的 DiskBlockObjectWriter —》
         *     write调用了对应序列化器的write方法 -》 然后调用了 ObjectOutput的write方法
         */
