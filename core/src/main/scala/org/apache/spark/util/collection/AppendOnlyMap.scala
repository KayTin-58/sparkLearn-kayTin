...
/**
 * :: DeveloperApi ::
 * A simple open hash table optimized【优化】 for the append-only use case, where keys
 * are never removed, but the value for each key may be changed.
 *
 * This implementation uses quadratic probing【平方探测法】 with a power-of-2 hash table
