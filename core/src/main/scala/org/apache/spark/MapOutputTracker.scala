 ...
 * driver and executor have different versions of the MapOutputTracker. In principle[原则上] the driver-
 ...
 * 用于从驱动程序的MapOutputTrackerMaster获取映射输出信息的执行端客户端。
